    ...
    <div className="h-screen bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4">
        ...
        <p className="text-neutral-500 max-w-lg mx-auto my-2 text-sm text-center relative z-10">
          Write content with AI by your side
        </p>
        <Input
          type="text"
          placeholder="hello@scribe.com"
          className="rounded-lg border border-neutral-800 focus:ring-2  w-full relative z-10 mt-4  bg-neutral-950 placeholder:text-neutral-700"
        />
      </div>
      <Beams />
    </div>
